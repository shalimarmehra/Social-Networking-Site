<?php
    ...
    if(isset($_POST['sign_up'])){
        ...
        values('$first_name',$last_name','$username','Hello SOUL MEDIA. This is my default status !','...','$pass','$email','$country','$gender',$birthday','$profile_pic','default_cover.jpg',NOW(),'$status','$posts','Iwnattoputadingintheuniverse')";
